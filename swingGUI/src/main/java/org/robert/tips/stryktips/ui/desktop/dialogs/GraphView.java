...
/**
 * This class creates a ordinary graph. This paint a graph where the
 * x-axis is from 0 - NUMBER_OF_GAMES and the y-axis shows an integer
 * value. The height is dynamic and takes the form of the highets number
 * in the graph data.
 * @author Robert Siwerz.
 */
public abstract class GraphView extends Canvas implements StryktipsConstants
{
    /**
    ...
    /**
     * Should be array of 14 integers, e.g 0 - 13 rights.
     */
    protected int[] data;
    ...
    public void paint(Graphics g)
    {
        ...
        for ( int i = 0; i < ( NUMBER_OF_GAMES - 3 ); i++ )
        {
        ...
        // plot 10 -13 rights       
        for ( int i = ( NUMBER_OF_GAMES - 3 ); i <= NUMBER_OF_GAMES; i++ )
        {
