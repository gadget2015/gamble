...
/**
  ...
  */
class ExtendedSystemButtonViewControllerHandler implements ActionListener, 
                                                           ...
                                                           StryktipsConstants
{
	 ...
	 */
	public ExtendedSystemButtonViewControllerHandler( StryktipsDocument stryktipsDocument ) 
	{
    ...
    */
    ...
    {       
		...
		{		
		    ...
		    try
		    {
			    stryktipsDocument.getStryktipsSystem().getExtended().setExtendedRow( rowNumber, buttonValue );
		...
		{		
		    ...
		    try
		    {
			    stryktipsDocument.getStryktipsSystem().getExtended().setExtendedRow( rowNumber, ( char )0 );
                            stryktipsDocument.setDocumentIsDirty(true);
