 ...
 */
public class SingleSystemContainer extends JPanel implements StryktipsTextMessages
{
    public SingleSystemContainer( StryktipsDocument stryktipsDocument ) throws GeneralApplicationException
    {
        ...
        titledBorder.setTitle( textMessages.getText( SINGLE_SYSTEM_TITLE ) );
