...
/**
 * Contains all components that is used to show the combination system data.
...
public class ParametersDataContainer extends JPanel implements StryktipsTextMessages
{
    public ParametersDataContainer( StryktipsDocument stryktipsDocument ) throws GeneralApplicationException
    {
        ...
        titledBorder.setTitle( textMessages.getText( COMBINATION_SYSTEM_DATA_TITLE ) );
        setBorder( titledBorder );
        
        GridBagConstraints constraints = new GridBagConstraints();
        
        // The input fields for number of rights in the singlerow system.
        RightsController rightsController = new RightsController( stryktipsDocument );
        constraints.gridx = 0;
        constraints.gridy = 0;
        ...
        CombinationsView combinationsView = new CombinationsView( stryktipsDocument );
        constraints.gridx = 0;
        constraints.gridy = 2;
        constraints.anchor = GridBagConstraints.NORTHWEST;
        add( combinationsView, constraints );               
    }
}