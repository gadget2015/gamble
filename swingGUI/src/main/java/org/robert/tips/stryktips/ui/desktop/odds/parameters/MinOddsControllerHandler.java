...
/**
  ...
  */
class MinOddsControllerHandler implements DocumentListener,
                                          ...
                                          ErrorMessages
{
	 ...
	 */
	public MinOddsControllerHandler( StryktipsDocument stryktipsDocument, JTextField stryktipsOddsField ) 
	{
    ...
    {       
        ...
        try
        {
            ...
            stryktipsDocument.getStryktipsSystem().getOdds().setMinimumOdds( value.floatValue() );                        
        }
