 ...
 */
public class ReducedRowsDialog extends JDialog implements StryktipsTextMessages
{
     ...
     */
    public ReducedRowsDialog( StryktipsGameType stryktipsGameType ) throws GeneralApplicationException
    {
        ...
        setTitle( textMessages.getText( VIEW_REDUCEDROWS_TITLE ) );
    }
}