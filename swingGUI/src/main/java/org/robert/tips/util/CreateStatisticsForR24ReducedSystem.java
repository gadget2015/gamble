...
/**
 * Create statistics for the R24 reduced system. Med detta menas att
 * ladda ett R-24 system och g� igenom alla raderna f�r att se vilka
 ...
 */
public class CreateStatisticsForR24ReducedSystem extends StatisticsSystem 
                                        
{
    private static final String RESOURCE_FILENAME = "R-24-210.txt";
    
    /**
     * Creates a new instance of this class.
     */
    public CreateStatisticsForR24ReducedSystem()
    {   
        try
        {
            ...
            mapSystemToMathimaticalSystem( rsystem, 24 );
    ...
    {
        new CreateStatisticsForR24ReducedSystem();   
    }
}