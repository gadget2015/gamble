...
/**
  * This is an eventhandler class for the single system buttons.
  * @author Robert Siwerz.
  */
class SingleSystemButtonViewControllerHandler implements ActionListener, 
                                                         ErrorMessages,
                                                         MaltipsConstants
{
	 ...
	 */
	public SingleSystemButtonViewControllerHandler( MaltipsDocument maltipsDocument ) 
	{
    ...
    */
    ...
    {       
		...
		{		
		    ...
		    try
		    {
			    maltipsDocument.getMaltipsSystem().getSingleSystem().setSingleSystemRow( rowNumber, rowNumber + 1 );
		...
		{		
		    ...
		    try
		    {
			    maltipsDocument.getMaltipsSystem().getSingleSystem().setSingleSystemRow( rowNumber, 0 );
                            maltipsDocument.setDocumentIsDirty(true);
