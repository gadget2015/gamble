...
/**
 * @version $Rev: 1385361 $ $Date: 2012-09-16 20:03:46 +0000 (Sun, 16 Sep 2012) $
 */
public class DataSourceFactory {
    ...
    public static DataSource create(final String name, final boolean configuredManaged, final Class impl, final String definition, Duration maxWaitTime, Duration timeBetweenEvictionRuns, Duration minEvictableIdleTime) throws IllegalAccessException, InstantiationException, IOException {
        LOGGER.info("Skapar DataSource:");
        LOGGER.info("name=" +name);
        LOGGER.info("configuredManaged=" + configuredManaged);
        LOGGER.info("Class=" + impl);
        LOGGER.info("definition="+ definition);
        LOGGER.info("maxWaitTime=" +maxWaitTime);
        LOGGER.info("timeBetweenEvictionRuns=" + timeBetweenEvictionRuns);
        LOGGER.info("minEvictableIdleTime=" + minEvictableIdleTime);
        ...
        if (createDataSourceFromClass(impl)) { // opposed to "by driver"
            ...
            LOGGER.info("Initierar DataSource:");
            Enumeration parameters = properties.elements();
            while(parameters.hasMoreElements()) {
            	Object value = parameters.nextElement();
